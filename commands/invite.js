...
exports.run = async(client, msg, args) => {
  ...
  .setAuthor('Support our bot!', client.user.displayAvatarURL)
                        ...
                        .setColor('#FFD800')
                        .addField('<:addrobot:514940409043222538> Invite bot', `[Click here](${'https://discordapp.com/api/oauth2/authorize?client_id=481305515092213763&permissions=3533920&scope=bot'})`, true)
                        .addField(':earth_asia: Join my server', `[Click here](${'https://discord.gg/x5uDzCw'})`, true)
